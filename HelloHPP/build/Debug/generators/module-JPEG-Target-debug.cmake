...
########## GLOBAL TARGET PROPERTIES Debug ########################################
    ...
    set_property(TARGET JPEG::JPEG
                 ...
                 $<$<CONFIG:Debug>:${libjpeg_LINKER_FLAGS_DEBUG}> APPEND)
    set_property(TARGET JPEG::JPEG
                 PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                 $<$<CONFIG:Debug>:${libjpeg_INCLUDE_DIRS_DEBUG}> APPEND)
    # Necessary to find LINK shared libraries in Linux
    set_property(TARGET JPEG::JPEG
                 PROPERTY INTERFACE_LINK_DIRECTORIES
                 $<$<CONFIG:Debug>:${libjpeg_LIB_DIRS_DEBUG}> APPEND)
    set_property(TARGET JPEG::JPEG
                 PROPERTY INTERFACE_COMPILE_DEFINITIONS
                 $<$<CONFIG:Debug>:${libjpeg_COMPILE_DEFINITIONS_DEBUG}> APPEND)
    set_property(TARGET JPEG::JPEG
                 PROPERTY INTERFACE_COMPILE_OPTIONS
                 $<$<CONFIG:Debug>:${libjpeg_COMPILE_OPTIONS_DEBUG}> APPEND)
