...
########## GLOBAL TARGET PROPERTIES Debug ########################################
    ...
    set_property(TARGET pugixml::pugixml
                 ...
                 $<$<CONFIG:Debug>:${pugixml_LINKER_FLAGS_DEBUG}> APPEND)
    set_property(TARGET pugixml::pugixml
                 PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                 $<$<CONFIG:Debug>:${pugixml_INCLUDE_DIRS_DEBUG}> APPEND)
    # Necessary to find LINK shared libraries in Linux
    set_property(TARGET pugixml::pugixml
                 PROPERTY INTERFACE_LINK_DIRECTORIES
                 $<$<CONFIG:Debug>:${pugixml_LIB_DIRS_DEBUG}> APPEND)
    set_property(TARGET pugixml::pugixml
                 PROPERTY INTERFACE_COMPILE_DEFINITIONS
                 $<$<CONFIG:Debug>:${pugixml_COMPILE_DEFINITIONS_DEBUG}> APPEND)
    set_property(TARGET pugixml::pugixml
                 PROPERTY INTERFACE_COMPILE_OPTIONS
                 $<$<CONFIG:Debug>:${pugixml_COMPILE_OPTIONS_DEBUG}> APPEND)
