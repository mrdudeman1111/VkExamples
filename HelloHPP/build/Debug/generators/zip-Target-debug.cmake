...
conan_package_library_targets("${kuba-zip_LIBS_DEBUG}"    # libraries
                              ...
                              "${kuba-zip_BIN_DIRS_DEBUG}" # package_bindir
                              "${kuba-zip_LIBRARY_TYPE_DEBUG}"
                              "${kuba-zip_IS_HOST_WINDOWS_DEBUG}"
                              kuba-zip_DEPS_TARGET
                              kuba-zip_LIBRARIES_TARGETS  # out_libraries_targets
                              "_DEBUG"
                              "kuba-zip"    # package_name
                              "${kuba-zip_NO_SONAME_MODE_DEBUG}")  # soname
...
########## GLOBAL TARGET PROPERTIES Debug ########################################
    ...
    set_property(TARGET zip::zip
                 ...
                 $<$<CONFIG:Debug>:${kuba-zip_LIB_DIRS_DEBUG}> APPEND)
    set_property(TARGET zip::zip
