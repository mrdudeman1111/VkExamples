...
########## GLOBAL TARGET PROPERTIES Debug ########################################
    ...
    set_property(TARGET poly2tri::poly2tri
                 ...
                 $<$<CONFIG:Debug>:${poly2tri_LINKER_FLAGS_DEBUG}> APPEND)
    set_property(TARGET poly2tri::poly2tri
                 PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                 $<$<CONFIG:Debug>:${poly2tri_INCLUDE_DIRS_DEBUG}> APPEND)
    # Necessary to find LINK shared libraries in Linux
    set_property(TARGET poly2tri::poly2tri
                 PROPERTY INTERFACE_LINK_DIRECTORIES
                 $<$<CONFIG:Debug>:${poly2tri_LIB_DIRS_DEBUG}> APPEND)
    set_property(TARGET poly2tri::poly2tri
                 PROPERTY INTERFACE_COMPILE_DEFINITIONS
                 $<$<CONFIG:Debug>:${poly2tri_COMPILE_DEFINITIONS_DEBUG}> APPEND)
    set_property(TARGET poly2tri::poly2tri
                 PROPERTY INTERFACE_COMPILE_OPTIONS
                 $<$<CONFIG:Debug>:${poly2tri_COMPILE_OPTIONS_DEBUG}> APPEND)
